...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Joissain tapauksissa LUODA ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi RustDeskin järjestelmään."),
        ...
        ("Language", "Kieli"),
        ("Keep LUODA background service", "Pidä RustDeskin taustapalvelu käynnissä"),
