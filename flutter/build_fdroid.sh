...
#
# - versionName from https://github.com/luoda/luoda/releases/download/fdroid-version/luoda-version.txt
# - versionCode from https://github.com/luoda/luoda/releases/download/fdroid-version/luoda-version.txt
...
arm64-v8a)
	...
	LUODA_FEATURES='flutter,hwcodec'
	;;
armeabi-v7a)
...
prebuild)
	...
	# Flutter used to compile main luoda library
	...
	# version used to compile luoda library, generate bridge using the
