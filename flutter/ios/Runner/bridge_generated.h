...
#define ERR_LUODA_HANDLE_BASE 10000
 ...
 */
bool luoda_core_main(void);

void handle_applicationShouldOpenUntitledFile(void);

char **luoda_core_main_args(int *args_len);

void free_c_args(char **ptr, int len);

int32_t get_luoda_app_name(uint16_t *buffer, int32_t length);
