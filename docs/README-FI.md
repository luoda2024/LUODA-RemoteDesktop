<p align="center">
  <img src="../res/logo-header.svg" alt="LUODA - Etätyöpöytäsi"><br>
...
Juttele meidän kanssa: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/luoda) | [Reddit](https://www.reddit.com/r/luoda) | [YouTube](https://www.youtube.com/@luoda)

[![LUODA Server Pro](https://img.shields.io/badge/LUODA%20Server%20Pro-Edistyneet%20Ominaisuudet-blue)](https://luoda.com/pricing.html)

Vielä yksi etätyöpöytäohjelmisto, ohjelmoitu Rust-kielellä. Toimii suoraan pakkauksesta, ei tarvitse asetusta. Hallitset täysin tietojasi, ei tarvitse murehtia turvallisuutta. Voit käyttää meidän rendezvous/relay-palvelinta, [aseta omasi](https://luoda.com/server), tai [kirjoittaa oma rendezvous/relay-palvelin](https://github.com/luoda/luoda-server-demo).

LUODA toivottaa avustukset tervetulleiksi kaikilta. Katso lisätietoja [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) avun saamiseksi.

[**BINAARILATAUS**](https://github.com/luoda/luoda/releases)
...
Varmista, että suoritat näitä komentoja LUODAtop-tietovaraston juurihakemistossa, muutoin sovellus ei ehkä löydä vaadittuja resursseja. Huomaa myös, että muita cargo-alikomentoja kuten `install` tai `run` ei nykyisin tueta tässä menetelmässä, koska ne asentavat tai suorittavat ohjelman säiliön sisällä eikä isäntäohjelman sisällä.

## Tiedostorakenne

- **[libs/hbb_common](https://github.com/luoda/luoda/tree/master/libs/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs-funktiot tiedostosiirtoon, ja jotkut muut apuohjelmafunktiot
- **[libs/scrap](https://github.com/luoda/luoda/tree/master/libs/scrap)**: näyttökaappaukset
- **[libs/enigo](https://github.com/luoda/luoda/tree/master/libs/enigo)**: platform specific keyboard/mouse control
- **[src/ui](https://github.com/luoda/luoda/tree/master/src/ui)**: Graafinen käyttöliittymä
