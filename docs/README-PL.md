<p align="center">
  <img src="../res/logo-header.svg" alt="LUODA - Twój zdalny pulpit"><br>
...
Porozmawiaj z nami na: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/luoda) | [Reddit](https://www.reddit.com/r/luoda) | [YouTube](https://www.youtube.com/@luoda)

[![LUODA Server Pro](https://img.shields.io/badge/LUODA%20Server%20Pro-Zaawansowane%20Funkcje-blue)](https://luoda.com/pricing.html)

## O projekcie

LUODA to wieloplatformowe oprogramowanie do zdalnego pulpitu, napisane w języku Rust, zaprojektowane z myślą o prostocie wdrożenia, bezpieczeństwie i pełnej kontroli użytkownika nad danymi. Aplikacja działa od razu po uruchomieniu i nie wymaga skomplikowanej konfiguracji. Możesz skorzystać z naszego darmowego serwera publicznego, [skonfigurować własny](https://luoda.com/server), lub [napisać własny serwer](https://github.com/luoda/luoda-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png) 

LUODA zaprasza do współpracy każdego. Zobacz [`docs/CONTRIBUTING-PL.md`](CONTRIBUTING-PL.md) pomoc w uruchomieniu programu.

[**PYTANIA I ODPOWIEDZI (FAQ)**](https://github.com/luoda/luoda/wiki/FAQ)

[**POBIERANIE BINARIÓW**](https://github.com/luoda/luoda/releases)
...
Upewnij się, że uruchamiasz te polecenia z katalogu głównego repozytorium LUODA, w przeciwnym razie aplikacja może nie być w stanie znaleźć wymaganych zasobów. Należy również pamiętać, że inne podpolecenia ładowania, takie jak `install` lub `run` nie są obecnie obsługiwane za pomocą tej metody, ponieważ instalowałyby lub uruchamiały program wewnątrz kontenera zamiast na hoście.

## Struktura plików

- **[libs/hbb_common](https://github.com/luoda/luoda/tree/master/libs/hbb_common)**: kodek wideo, konfiguracja, obsługa tcp/udp, protobuf, funkcje systemu plików do transferu plików i kilka innych funkcji użytkowych
- **[libs/scrap](https://github.com/luoda/luoda/tree/master/libs/scrap)**: przechwytywanie ekranu
- **[libs/enigo](https://github.com/luoda/luoda/tree/master/libs/enigo)**: specyficzne dla danej platformy sterowanie klawiaturą/myszą
- **[src/ui](https://github.com/luoda/luoda/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/luoda/luoda/tree/master/src/server)**: audio/schowek/wejście(input)/wideo oraz połączenia sieciowe
- **[src/client.rs](https://github.com/luoda/luoda/tree/master/src/client.rs)**: uruchamia połączenie bezpośrednie
- **[src/rendezvous_mediator.rs](https://github.com/luoda/luoda/tree/master/src/rendezvous_mediator.rs)**: Komunikacja z [luoda-server](https://github.com/luoda/luoda-server), czekanie na bezpośrednie (odpytywanie TCP) lub przekazywane połączenie
- **[src/platform](https://github.com/luoda/luoda/tree/master/src/platform)**: kod specyficzny dla danej platformy
- **[flutter](https://github.com/luoda/luoda/tree/master/flutter)**: kod Flutter dla urządzeń mobilnych
- **[flutter/web/js](https://github.com/luoda/luoda/tree/master/flutter/web/js)**: JavaScript dla Flutter - klient web
