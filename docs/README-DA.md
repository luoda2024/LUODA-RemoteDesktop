<p align="center">
  ...
  <b>Vi har brug for din hjælp til at oversætte denne README, <a href="https://github.com/luoda/luoda/tree/master/src/lang">LUODA UI</a> og <a href=" https://github.com/luoda/doc.luoda.com">Dokument</a> til dit modersmål</b>
</p>

Chat med os: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/luoda) | [Reddit](https://www.reddit.com/r/luoda) | [YouTube](https://www.youtube.com/@luoda)

[![LUODA Server Pro](https://img.shields.io/badge/LUODA%20Server%20Pro-Avancerede%20Funktioner-blue)](https://luoda.com/pricing.html)

Endnu en fjernskrivebordssoftware, skrevet i Rust. Fungerer ud af æsken, ingen konfiguration påkrævet. Du har fuld kontrol over dine data uden bekymringer om sikkerhed. Du kan bruge vores rendezvous/relay-server, [opsætte din egen](https://luoda.com/server), eller [skrive din egen rendezvous/relay-server](https://github.com/luoda/luoda- server-demo).

LUODA hilser bidrag fra alle velkommen. Se [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) for at få hjælp til at komme i gang.

[**PROGRAM DOWNLOAD**](https://github.com/luoda/luoda/releases)
...
## [Byg](https://luoda.com/docs/en/dev/build/)
...
Sørg for, at du kører disse kommandoer fra roden af LUODA-lageret, ellers kan applikationen muligvis ikke finde de nødvendige ressourcer. Bemærk også, at andre cargo underkommandoer såsom 'install' eller 'run' i øjeblikket ikke understøttes via denne metode, da de ville installere eller køre programmet inde i containeren i stedet for værten.

## Filstruktur

- **[libs/hbb_common](https://github.com/luoda/luoda/tree/master/libs/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs funktioner til filoverførsel og nogle andre hjælpefunktioner
- **[libs/scrap](https://github.com/luoda/luoda/tree/master/libs/scrap)**: Skærmbillede
- **[libs/enigo](https://github.com/luoda/luoda/tree/master/libs/enigo)**: platform specifik tastatur/mus kontrol
- **[src/ui](https://github.com/luoda/luoda/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/luoda/luoda/tree/master/src/server)**: lyd/udklipsholder/input/videotjenester og netværksforbindelser
- **[src/client.rs](https://github.com/luoda/luoda/tree/master/src/client.rs)**: starte en peer-forbindelse
- **[src/rendezvous_mediator.rs](https://github.com/luoda/luoda/tree/master/src/rendezvous_mediator.rs)**: Kommuniker med [luoda-server](https://github.com/luoda/luoda-server), vent på direkte fjernforbindelse (TCP-hulning) eller relæforbindelse
- **[src/platform](https://github.com/luoda/luoda/tree/master/src/platform)**: Javascript til Flutter webklient
